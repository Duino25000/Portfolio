...
<!--******************** PROJET PERSO *****************************-->
	<section id="projetPerso">

		<div class="titre">
			<hr><h2>MES PROJETS PERSO</h2><hr>
		</div>
		<h2>Projets réalisés dans le cadre personnel .</h2>	

		<div id="lignePerso">

			<div id="ceSite">
				<h3>Ce site web :<br/>Duino.fr</h3>
				<div id="box7">
...
<!--******************************* #CONTACT ****************************************-->
	<section id="contact">
		...
		<h2>N'hésitez pas à laisser un message !</h2>
