...
<!--****************************************** TECHNOLOGIE ****************************************************-->
	<section id="siteTXT2">
		...
		<img class="imageProjet" src="assets/images/codeCss.jpg" alt="image site blueasy">
		<p>Site dynamique réalisé avec HTML5, CSS3, JavaScript et PHP. Un seul fichier CSS pour tout le site hormis les sites externes. Aucuns autres langages ni Framework n'a été utilisés. Respect des normes W3C. Gestion du responsive design avec Flexbox et Media queries (2 breakpoints).</p>
	</section>
<!--********************************************* AMELIORATION *****************************************************************-->
	<section id="siteTXT3">
		<div class="titre">
		...
		<p>Des sondages/questionnaires, la listes des mises à jours ainsi que l'historique des anciennes versions du site seront ajoutés. Si vous avez des questions, des suggestions ou simplement pour me donner votre avis qui m'aidera beaucoup, n'hésitez pas envoyez un message dans la rebrique "Contact" de la page accueil.</p>
	</section>
<!--********************************************** FOOTER *********************************************************************-->
